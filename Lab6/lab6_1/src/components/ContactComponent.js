          ...
          <div className="col-12 col-md-9">
            <Form onSubmit={this.handleSubmit}>
              ...
              <FormGroup row>
                ...
                <Col md={10}>
                  <Input type="tel" id="telnum" name="telnum" placeholder="Tel. Number" value={this.state.telnum} onChange={this.handleInputChange} required/>
                </Col>
              </FormGroup>
              <FormGroup row>
              ...
              <FormGroup row>
                <Col md={{size : 6, offset: 2}}>
                  <FormGroup check>
                    <Label check>
                      <Input type="checkbox" name="agree" checked={this.state.agree} onChange={this.handleInputChange} required/> {''} <strong>May we contact you?</strong>
                    </Label>
                  </FormGroup>
                </Col>
              ...
              <FormGroup row>
                <Label htmlFor="message" md={2}>Your Feedbacks</Label>
                <Col md={10}>
